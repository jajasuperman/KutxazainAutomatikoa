...
public class NirePanela extends JPanel implements ActionListener {
    ...
    private JLabel etiketaBezeroKontuak;
    private JComboBox listaBezeroKontuak;
    // Modeloak
    ...
    private void gehituKontrolak() {
        ...
        etiketaBezeroKontuak = new JLabel("Bezeroaren Kontuak:");
        this.add(etiketaBezeroKontuak);
